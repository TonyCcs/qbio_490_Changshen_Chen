...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir =   normalizePath("/Users/chenchangshen/Desktop/qbio_490_Changshen_Chen")) 
```
...
string_var <- "I need more vacations"
char_var <- 'A'
...
age <- 19
birthday <- "07/01/2004"
three_fav_colors <- c("black, grey, white")
print(name)
print(age)
print(birthday)
...
```{r Exercise 5.2}
"cat" == "cat" & "dog" == "dog" # prediction: Ture
...
if (test_number > 5) {
  print ("Fail!") #skipped as 1 is not greater than 5
} else if (test_number < 5) {
  print ("Success!")
} else {
  print ("Fail!") # skipped as one of the above conditions is met
}
```
...
hp_D3 = mtcars[7,4] #horse power data for the Duster 360
hp_LC = mtcars[16,4] #horse power data for the Lincoln Continenta
hp_MB = mtcars[31,4] #horse power data for the Maserati Bora
